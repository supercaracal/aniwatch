...
Lineup.create(
  [
    ...
    { title: '笑ゥせぇるすまんNEW', start_time: '23:00:00', channel: ch9, day_of_week: mon },
    ...
    { title: 'サクラダリセット', start_time: '23:30:00', channel: ch9, day_of_week: wed },
    ...
    { title: '月がきれい', start_time: '00:00:00', channel: ch9, day_of_week: fri },
    ...
    { title: 'ひなこのーと', start_time: '01:30:00', channel: ch9, day_of_week: sat },
    ...
    { title: '有頂天家族2', start_time: '22:00:00', channel: ch9, day_of_week: sun },
