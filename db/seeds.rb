...
Lineup.create(
  [
    ...
    { title: '3D彼女 リアルガール', start_time: '01:30:00', channel: ch4, day_of_week: wed },
    ...
    { title: '多田くんは恋をしない', start_time: '22:00:00', channel: ch9, day_of_week: thu },
    { title: '銀河英雄伝説 Die Neue These', start_time: '22:30:00', channel: ch9, day_of_week: thu },
    { title: 'こみっくがーるず', start_time: '23:30:00', channel: ch9, day_of_week: thu },
    { title: 'メガロボクス', start_time: '01:30:00', channel: ch6, day_of_week: fri },
    { title: 'されど罪人は竜と踊る', start_time: '02:00:00', channel: ch6, day_of_week: fri },
